...
3. Click **Run diagnosis** and narrate the evidence plan: logs, deployment, runbook, and historical incident.
4. Point out that every claim cites a retrieved evidence ID.
5. Show the rollback proposal and the explicit human-review boundary.
6. Open the Evaluation view and explain why unpublished metrics remain pending instead of being invented.
